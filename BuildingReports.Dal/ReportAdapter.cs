...
namespace BuildingReports.Dal
{
    public class ReportAdapter
    {

        private string _connectionString = @"Data Source=C:\Users\bryce\OneDrive\C#\C# 2 class\ModifyingDatabaseData\ModifyingDatabaseData\bin\Debug\Chinook_Sqlite_AutoIncrementPKs.sqlite;datetimeformat=CurrentCulture;";
